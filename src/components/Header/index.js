      ...
      <header className={style.header}>
        <div className={style.container}>
          ...
          <nav className={navbar}>
            <ul>
              <li>
                <Link activeClassName={line} to="/">
                  Main
                </Link>
              </li>
              <li>
                <Link activeClassName={line} to="/about">
                  About
                </Link>
              </li>
              <li>
                <Link activeClassName={line} to="/contact">
                  Contact
                </Link>
              </li>
              <li>
