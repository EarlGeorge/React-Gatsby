...
export default () => {
  return (
    <Layout>
      ...
      <AboutMe>
        <p>
          My name is George Davituri. I am studying and researching Science which is slightly overused word LOL😂:) Literally obsessed with coding & innovative technology.
